...
yurikorobot_IMG = "https://telegra.ph//file/79e261bf6094759e81624.jpg"
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ᴀᴅᴅ ᴀɴɢᴇʟᴀ ᴛᴏ ᴜʀ ᴄʜᴀᴛ", url="t.me/AngelaRobot_bot?startgroup=true"),
    ],
]


HELP_STRINGS = """
I'm ᴀɴɢᴇʟᴀ, a full-fledged group management bot built to help you manage your group easily.
I can do a lot of stuff, here is one list of common things I can do:
• I can restrict users via ban permissions.
• I can greet users with most customisable welcome messages.
• I have an advanced anti-flood systems.
• I can warn users until they reach max warns, with each predefined actions such as ban, mute, kick etc.
• I can send users that used predefined filters, blacklist, notes in your chat.
...there is much more stuff check out /help!
...
And finally, My creator is this [this person](t.me/EngrJuanMala).
"""



DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [Juan](t.me/EngrJuanMala) \
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url="t.me/EngrJuanMala"),]]
            ),
        )
...
def yurikorobot_about_callback(update, context):
    ...
    if query.data == "yurikorobot_":
        query.message.edit_text(
            text=""" ᴀɴɢᴇʟᴀ - `A bot to manage your groups with additional features!`
            \n`Here the basic help regarding use of Angela.`
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Congragulations, ᴀɴɢᴇʟᴀ now ready to manage your group.`"
            f"\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            f"\n\n✗ *Lets Enjoy The Waldo Music Bot*"
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back", callback_data="yurikorobot_back")]]
        ...
        query.message.edit_text(
            text=f"<b> CREDIT FOR ᴀɴɢᴇʟᴀ DEV'S</b>\n"
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..😻 I'm ᴀɴɢᴇʟᴀ
                 \nHere is the [🔥Source Code🔥](https://github.com/HairyPotah02/Angela-Bot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
